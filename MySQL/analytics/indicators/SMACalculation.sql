...
BEGIN
	...
	IF (_market = 'kraken') THEN INSERT INTO analytics.kraken_indicators (`coinpair`,`sma5min`,`sma20min`,`sma60min`,`sma24h`,`timestamp`) VALUES (_coinpair,@_sma5min,@_sma20min,@_sma60min,@_sma24h,@_timestamp);
	END IF;
    IF (_market = 'binance') THEN INSERT INTO analytics.binance_indicators (`coinpair`,`sma5min`,`sma20min`,`sma60min`,`sma24h`,`timestamp`) VALUES (_coinpair,@_sma5min,@_sma20min,@_sma60min,@_sma24h,@_timestamp);
	END IF;
